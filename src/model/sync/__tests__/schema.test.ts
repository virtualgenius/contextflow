...
describe('Yjs Schema Type Definitions', () => {
  describe('Type Exports', () => {
    ...
    it('exports YjsNeedContextConnection type', () => {
      const assertType: YjsNeedContextConnection = {} as YjsNeedContextConnection
      expect(assertType).toBeDefined()
    })
  ...
  describe('Nested Y.Map Structure', () => {
    it('creates nested Y.Map for positions', () => {
      ...
      const retrievedDistillation = retrievedPositions.get('distillation') as Y.Map<unknown>
  ...
  describe('Array Structures', () => {
    it('creates Y.Array for contexts', () => {
      ...
      // Verify structure
      const retrievedContexts = yproject.get('contexts') as Y.Array<Y.Map<unknown>>
    ...
    it('creates Y.Array for relationships', () => {
      ...
      // Verify structure
      const retrievedRelationships = yproject.get('relationships') as Y.Array<Y.Map<unknown>>
    ...
    it('creates Y.Array for issues within a context', () => {
      ...
      // Verify structure
      const retrievedIssues = ycontext.get('issues') as Y.Array<Y.Map<unknown>>
